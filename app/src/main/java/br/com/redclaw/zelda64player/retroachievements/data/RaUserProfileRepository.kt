 ...
 * https://retroachievements.org/controlpanel.php (the `y` query parameter) — not the rcheevos login
 * token. The key is supplied only as an encoded query parameter and is never logged or cached with
 * the profile.
 */
