 ...
 *
 * MM reuses the same icon archive layout as OoT: 32x32 RGBA32, stride 0x1000.
 * Offsets are provisional (same order as OoT where applicable); refine via
 * zeldaret/mm when the decomp exposes the texture table.
 */
object MmIconMap {
    ...
    val entries: List<IconMapping> =
            listOf(
                    ...
                    IconMapping("great_fairy_sword", ICON, 0x3000, format = N64TextureFormat.RGBA32),
                    ...
                    IconMapping("lens_of_truth", ICON, 0xA000, format = N64TextureFormat.RGBA32),
                    IconMapping("pictobox", ICON, 0xB000, format = N64TextureFormat.RGBA32),
                    IconMapping("bombers_notebook", ICON, 0xC000, format = N64TextureFormat.RGBA32),
                    IconMapping("ocarina_of_time", ICON, 0xD000, format = N64TextureFormat.RGBA32),
                    ...
                    IconMapping("light_arrows", ICON, 0x10000, format = N64TextureFormat.RGBA32),
                    ...
                    IconMapping("odolwa_remains", ICON, 0x13000, format = N64TextureFormat.RGBA32),
                    IconMapping("goht_remains", ICON, 0x14000, format = N64TextureFormat.RGBA32),
                    IconMapping("gyorg_remains", ICON, 0x15000, format = N64TextureFormat.RGBA32),
                    IconMapping("twinmold_remains", ICON, 0x16000, format = N64TextureFormat.RGBA32),
                    ...
                    IconMapping("fierce_deity_mask", ICON, 0x1A000, format = N64TextureFormat.RGBA32),
                    IconMapping("great_fairy_mask", ICON, 0x1B000, format = N64TextureFormat.RGBA32),
                    IconMapping("romani_mask", ICON, 0x1C000, format = N64TextureFormat.RGBA32),
                    IconMapping("circus_leader_mask", ICON, 0x1D000, format = N64TextureFormat.RGBA32),
                    IconMapping("kafei_mask", ICON, 0x1E000, format = N64TextureFormat.RGBA32),
                    IconMapping("couples_mask", ICON, 0x1F000, format = N64TextureFormat.RGBA32),
                    IconMapping("postman_hat", ICON, 0x20000, format = N64TextureFormat.RGBA32),
                    IconMapping("all_night_mask", ICON, 0x21000, format = N64TextureFormat.RGBA32),
                    ...
                    IconMapping("don_gero_mask", ICON, 0x26000, format = N64TextureFormat.RGBA32),
                    ...
                    IconMapping("captains_hat", ICON, 0x2A000, format = N64TextureFormat.RGBA32),
                    IconMapping("giants_mask", ICON, 0x2B000, format = N64TextureFormat.RGBA32),
                    IconMapping("mask_of_truth", ICON, 0x2C000, format = N64TextureFormat.RGBA32),
                    IconMapping("mask_of_scents", ICON, 0x2D000, format = N64TextureFormat.RGBA32),
