 ...
 *
 * MM icons are 32x32 RGBA16 (same stride as OoT) for most items; some HUD
 * variants are 24x24. Offsets are sequential in the decompressed archive.
 * TODO: confirm exact offsets and dmaFileIndex via zeldaret/mm.
 */
object MmIconMap {
