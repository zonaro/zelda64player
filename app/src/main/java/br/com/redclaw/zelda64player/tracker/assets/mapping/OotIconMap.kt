 ...
 *
 * Each icon is 32x32 RGBA16 = 2048 bytes (0x800). Offsets are sequential.
 * Source: zeldaret/oot `assets/xml/icon_item_static.xml` + OoTMM.
 * TODO: confirm exact offsets and dmaFileIndex via Calamari/Puffy.
 */
object OotIconMap {
    ...
    val entries: List<IconMapping> = listOf(
        ...
        IconMapping("ocarina", ICON, 0x3800), // fairy ocarina / ocarina of time share slot
        ...
        // Tunics / shields / boots — may live in a different file (e.g. icon_item_dungeon)
