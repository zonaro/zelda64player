...
const I18N = {
  pt: {
    ...
    "f.randomizer.desc": "Randomizador/plandomizer de Ocarina of Time via API OoTR (~200 opções), patches ZPF/ZPFZ e recálculo de CRC de boot N64 (CIC 6105).",
  ...
  en: {
    ...
    "f.randomizer.desc": "Ocarina of Time randomizer/plandomizer via OoTR API (~200 options), ZPF/ZPFZ patches and N64 boot CRC recompute (CIC 6105).",
    "f.ocarina.title": "Auto-Ocarina",
  ...
  es: {
    ...
    "f.randomizer.desc": "Randomizer/plandomizer de Ocarina of Time vía API OoTR (~200 opciones), parches ZPF/ZPFZ y recálculo de CRC de arranque N64 (CIC 6105).",
    "f.ocarina.title": "Auto-Ocarina",
