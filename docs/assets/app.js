...
const I18N = {
  pt: {
    ...
    "catalog.sub": "Hacks da Main Store (o mesmo JSON usado pelo app), incluindo metadados públicos importados do Hylian Modding.",
    ...
    "f.multistore.title": "Catálogo unificado Main Store",
    "f.multistore.desc": "Explore uma única loja: a Main Store reúne entradas curadas e metadados públicos importados do Hylian Modding, com autoria, capas, screenshots e detalhes ricos.",
...
"f.checksum.title": "Correspondência de ROM base por checksum",
    ...
    "fPoints": {
      ...
      "multistore": ["Uma única loja Main Store", "Metadados públicos do Hylian Modding com crédito da fonte", "Catálogo JSON curado e atualizado"],
  ...
  en: {
    ...
    "catalog.sub": "Hacks from Main Store (the same JSON used by the app), including public metadata imported from Hylian Modding.",
    ...
    "f.multistore.title": "Unified Main Store catalog",
    "f.multistore.desc": "Browse one store: Main Store combines curated entries with public metadata imported from Hylian Modding, including authors, covers, screenshots and rich details.",
    ...
    "fPoints": {
      ...
      "multistore": ["One Main Store store", "Public Hylian Modding metadata with source credit", "Curated, refreshed JSON catalog"],
  ...
  es: {
    ...
    "catalog.title": "Catálogo de Hacks",
    "catalog.sub": "Hacks de Main Store (el mismo JSON usado por la app), incluidos metadatos públicos importados de Hylian Modding.",
    ...
    "f.multistore.title": "Catálogo unificado Main Store",
    "f.multistore.desc": "Explora una sola tienda: Main Store reúne entradas curadas y metadatos públicos importados de Hylian Modding, con autores, portadas, capturas y detalles ricos.",
...
"f.checksum.title": "Coincidencia de ROM base por checksum",
    ...
    "fPoints": {
      ...
      "multistore": ["Una sola tienda Main Store", "Metadatos públicos de Hylian Modding con crédito de la fuente", "Catálogo JSON curado y actualizado"],
